% Partial derivatives calculation function for refracted ray tomography
% from Parameter Estimation and Inverse Problems, 3rd edition, 2018
% by R. Aster, B. Borchers, C. Thurber
%
% [J,ttcal,rpstore]=getj(PSCALE,NIT,CONV,XFAC,xn,zn,v,sc,rc,calcrays,rpinit)
%
% J is the Jacobian function of travel time partial derivatives with respect
...
% calcrays=0 reinitializes the ray paths; calcrays ~= 0 uses the starting raypaths stored in the 3-d array rpinit.
%
